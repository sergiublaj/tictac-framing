...
;; cars
(ag_percept (percept_pobj red_car) (percept_pname partof) (percept_pval lane_3))
...
;; cars
(ag_percept (percept_pobj red_car) (percept_pname width) (percept_pval 1.5))
...
;; PERCEPT TYPE: space
;; cars
(ag_percept (percept_pobj red_car) (percept_pname space_right) (percept_pval 2.5))
(ag_percept (percept_pobj blue_car) (percept_pname space_front) (percept_pval 2))
(ag_percept (percept_pobj ego) (percept_pname space_left) (percept_pval 2.5))
