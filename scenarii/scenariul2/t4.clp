...
;; cars
(ag_percept (percept_pobj red_car) (percept_pname distance_to_crosswalk) (percept_pval 0))
(ag_percept (percept_pobj blue_car) (percept_pname distance_to_crosswalk) (percept_pval 10))
(ag_percept (percept_pobj orange) (percept_pname distance_to_crosswalk) (percept_pval 25))
