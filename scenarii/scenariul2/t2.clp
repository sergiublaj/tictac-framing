...
;; cars
(ag_percept (percept_pobj red_car) (percept_pname distance_to_crosswalk) (percept_pval 20))
(ag_percept (percept_pobj blue_car) (percept_pname distance_to_crosswalk) (percept_pval 30))
(ag_percept (percept_pobj orange) (percept_pname distance_to_crosswalk) (percept_pval 45))
(ag_percept (percept_pobj ego) (percept_pname distance_to_crosswalk) (percept_pval 30))
(ag_percept (percept_pobj yellow_car) (percept_pname distance_to_crosswalk) (percept_pval 50))
