...
;; PERCEPT TYPE: horn
;; cars
(ag_percept (percept_pobj yellow_car) (percept_pname horn) (percept_pval on))
...
;; cars
(ag_percept (percept_pobj blue_car) (percept_pname distance_to_crosswalk) (percept_pval 0))
(ag_percept (percept_pobj orange) (percept_pname distance_to_crosswalk) (percept_pval 10))
(ag_percept (percept_pobj ego) (percept_pname distance_to_crosswalk) (percept_pval 27))
(ag_percept (percept_pobj yellow_car) (percept_pname distance_to_crosswalk) (percept_pval 35))
