...
;; cars
(ag_percept (percept_pobj red_car) (percept_pname angle_with_statue) (percept_pval 80))
(ag_percept (percept_pobj ego) (percept_pname angle_with_statue) (percept_pval 15))
