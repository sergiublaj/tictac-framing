...
;; cars
(ag_percept (percept_pobj red_car) (percept_pname partof) (percept_pval right_lane_1_1))
...
;; cars
(ag_percept (percept_pobj red_car) (percept_pname angle_with_statue) (percept_pval 90))
(ag_percept (percept_pobj ego) (percept_pname angle_with_statue) (percept_pval 75))
...
(ag_percept (percept_pobj ego) (percept_pname direction) (percept_pval left))



;; PERCEPT TYPE: distance_to_roundabout
;; cars
(ag_percept (percept_pobj red_car) (percept_pname distance_to_roundabout) (percept_pval 10))
